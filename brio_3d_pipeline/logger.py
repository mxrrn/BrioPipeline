"""
Automatic timestamped logging for all slow pipeline scripts.

Usage (add two lines at the top of any entry-point script):

    from logger import setup_logging
    setup_logging("samples_113_114")   # creates logs/YYYYMMDD_HHMMSS_samples_113_114.log
...
def setup_logging(label: str = "run") -> Path:
    ...
    Args:
        label : short description appended to the filename
